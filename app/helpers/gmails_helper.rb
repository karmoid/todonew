	...
	def to_pretty
		if self.to_date <= Time.now.to_date
			...
			case a
			  ...
			  when 3..6 then return I18n.t(:lastweek) # "La semaine pass\u00E9e" 
			...
			case a
			  ...
			  when 2 then return I18n.t(:after) +"-Demain"
			  when 3..6 then return "La semaine " + I18n.t(:togo) 
			  ...
			  else return "Dans " + I18n.t(:verylongtime)
			end
		end	
	end
end
